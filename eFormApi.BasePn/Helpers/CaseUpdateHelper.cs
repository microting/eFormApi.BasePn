...
namespace Microting.eFormApi.BasePn.Helpers
{
        ...
        public static List<string> GetFieldValuesByRequestField(CaseEditRequestField editRequestField)
        {
            ...
            switch (editRequestField.FieldType)
            {
                case "CheckBox":
                    ...
                    {
                        var val = $"{checkBoxfirst.FieldId}|{checkBoxfirst.Value.ToString()}";
                        list.Add(val);
                    }
                ...
                case "Comment":
                    ...
                    {
                        var val = $"{commentFirst.FieldId}|{commentFirst.Value.ToString()}";
                        list.Add(val);
                    }
                ...
                case "Date":
                    ...
                    if (dateFirst?.Value != null && dateFirst?.FieldId != null)
                    {
                        try
                        {
                            var currentDate = (DateTime) dateFirst.Value;
                            if (currentDate != null)
                            {
                                var val = $"{dateFirst.FieldId}|{currentDate:yyyy-MM-dd}";
                                list.Add(val);
                            }
                        }
                        catch
