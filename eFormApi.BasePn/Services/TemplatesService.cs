            ...
            catch (Exception ex)
            {
                if (ex.Message.Contains("PrimeDb"))
                {
                    ...
                    return new OperationDataResult<TemplateListModel>(false,
                        LocaleHelper.GetString("CheckConnectionString"));
                }
                ...
                if (ex.InnerException.Message.Contains("Cannot open database"))
                {
                    ...
                    {
                        return new OperationDataResult<TemplateListModel>(false,
                            LocaleHelper.GetString("CoreIsNotStarted"));
                    }

                    return new OperationDataResult<TemplateListModel>(false,
                        LocaleHelper.GetString("CheckSettingsBeforeProceed"));
                }
        ...
        public OperationResult Create(EFormXmlModel eFormXmlModel)
        {
            try
            {
                ...
                return new OperationResult(true,
                    LocaleHelper.GetString("eFormParamCreatedSuccessfully", newTemplate.Label));
            }
            catch (Exception e)
            {
            ...
            try
            {
                return result
                    ? new OperationResult(true,
                        LocaleHelper.GetString("eFormParamDeletedSuccessfully", templateDto.Label))
                    : new OperationResult(false,
                        LocaleHelper.GetString("eFormParamCouldNotBeDeleted", templateDto.Label));
            }
            catch (Exception)
            {
